    ...
    <>
      <div className="h-screen bg-zinc-950 flex flex-col">
        ...
        <main className="flex-1 flex flex-col p-6 mt-[-140px] mx-auto w-full max-w-[720px] overflow-hidden">
          <h1 className="text-gray-50 text-2xl text-center font-bold mb-8">Login</h1>
          ...
          >
            ...
            <p className="mt-2 text-gray-400 text-sm text-center">Não tem uma conta? <Link href="/signup" className="font-bold text-purple-500">Registre-se</Link></p>
